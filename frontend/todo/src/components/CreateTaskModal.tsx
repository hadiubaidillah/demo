  ...
  return (
    <Modal {...modalProps}>
      ...
      <ModalContent as={'form'} onSubmit={handleSubmit(onSubmit)}>
        ...
        <ModalFooter gap={2}>
          <Button colorScheme={'blackAlpha'} onClick={modalProps.onClose}>Cancel</Button>
          <Button isLoading={isMutating} name={'Create'} type='submit' aria-label='Create a task' colorScheme={'telegram'}>Create</Button>
        </ModalFooter>
      </ModalContent>
    </Modal>
  );
